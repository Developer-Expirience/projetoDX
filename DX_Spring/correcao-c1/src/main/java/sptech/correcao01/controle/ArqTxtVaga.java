...
//                    corpo += String.format("%6.2s", vaga.getDescricao());
//                    corpo += String.format("%4s", vaga.getUrlImagem());
...
//                Double valor;
//                String tipoRegistro, registro, descricao, urlImagem, titulo, seneoridade;
//                int idVaga;
...
//                            titulo = registro.substring(33,43).trim();
//                            seneoridade = registro.substring(43, 53).trim();
//                            urlImagem = registro.substring(43, 80).trim();
//                            contaRegDadoLido++;
//
//                            // Instancia um objeto vaga com as informações lidas
//                            Vaga vaga = new Vaga(idVaga, descricao, titulo, urlImagem, seneoridade);
//
